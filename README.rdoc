...
- Frontpage has now javascript based filter
  - Improvet filter: separate search
...
- New Course View: Add info for Timer
- Deploy at Heroku or...!
- Add info for new admin view (lengt, special chars)
- JS filter:
...
Done in Calendar Week
34:
- Admin Valdiation: Require strenght password valdiation 
- Course Validation: Times Validation
